 ...
 * 3. rendering mold (@see mold/columnchooser.js )
 ...
 *
 */
columnchooser.org.zkoss.addon.columnchooser.Columnchooser = zk.$extends(zul.Widget, {
	...
	*/
	bind_: function () {
		 ...
		 */
		this.$supers(columnchooser.org.zkoss.addon.columnchooser.Columnchooser,'bind_', arguments);
	...
	*/
	unbind_: function () {
		...
		*/
		this.$supers(columnchooser.org.zkoss.addon.columnchooser.Columnchooser,'unbind_', arguments);
	},
	/*
	...
	getZclass: function () {
		return this._zclass != null ? this._zclass: "z-columnchooser";
	}
});